...
export function HeroContent() {
  return (
    <Container
      as="section"
      className="relative w-full lg:max-w-2xl lg:pr-12"
    >
      <a
      ...
      >
        <svg fill="currentColor" viewBox="0 0 24 24" className="size-4 sm:size-5">
          <path
            fillRule="evenodd"
      ...
      <div className="mt-8 sm:mt-10 flex items-start sm:items-center gap-4 sm:gap-5">
        ...
        >
          <Link href="/mata-kuliah">
            Mata Kuliah <ChevronRight className="size-3 sm:size-4 group-hover:translate-x-1 transition-transform" />
          </Link>
        </Button>
        <Button
          variant="ghost"
